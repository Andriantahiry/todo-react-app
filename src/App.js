        ...
        <div className="filter">
          <div className='container'>
            ...
            {filtered.map((element) => <div className={`list-group-item  listes ${element.completed && 'completed'}`} key={element.id}>
              ...
              {<p>{element.text} <input checked={element.completed} className='checkbox' onChange={() => checker(element)} type="checkbox" /> <span> <button onClick={() => editElement(element)} className='edit'><svg xmlns="http://www.w3.org/2000/svg" root="" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
